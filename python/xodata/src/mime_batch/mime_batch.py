...
class BatchRequest:
    ...
    total_time: float = field(default=0.0, init=False, repr=False)
    ...
    def report_stats(
        ...
        stats: dict[str, int | float | datetime.datetime] = {
            ...
            "total_time": _decimal_6(self.total_time),
    ...
    def average_time_per_post(self) -> float:
        return self.total_time / self.post_count if self.post_count else 0.0

    @property
    def average_time_per_part(self) -> float:
        return self.total_time / self.total_parts if self.total_parts else 0.0
